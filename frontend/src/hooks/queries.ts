...
export const useIncomes = () => useQuery({ queryKey: QueryKeys.incomes, queryFn: getIncomes });

export const useOutgoings = () =>
  useQuery({ queryKey: QueryKeys.outgoings, queryFn: getOutgoings });

export const useAccounts = () => useQuery({ queryKey: QueryKeys.accounts, queryFn: getAccounts });
...
export const useLiabilityOverpayments = () =>
  useQuery({
    queryKey: QueryKeys.liabilityOverpayments,
    queryFn: () => getLiabilityOverpayments(),
  });
