...
export const createWealthSource = async (data: {
  name: string;
  category: string;
  color?: string;
...
export const updateWealthSource = async (
  id: string,
...
export const updateIncome = async (
  id: string,
  data: Partial<Omit<IncomeSource, 'id'>>,
...
export const updateOutgoing = async (
  id: string,
  data: Partial<Omit<OutgoingSource, 'id'>>,
...
export const createAllocation = async (
  data: Omit<Allocation, 'id' | 'account'>,
): Promise<Allocation> => {
...
export const updateAllocation = async (
  id: string,
  data: Partial<Omit<Allocation, 'id' | 'account'>>,
): Promise<Allocation> => {
...
export const createLiability = async (
  data: Omit<Liability, 'id' | 'property' | 'createdAt' | 'updatedAt'>,
): Promise<Liability> => {
...
export const updateLiability = async (
  id: string,
  data: Partial<Omit<Liability, 'id' | 'property' | 'createdAt' | 'updatedAt'>>,
): Promise<Liability> => {
...
// Overpayments
export const getLiabilityOverpayments = async (
  liabilityId?: string,
