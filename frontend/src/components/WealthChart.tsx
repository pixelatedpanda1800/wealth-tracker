                ...
                {sortedPayload.map((entry: any) => {
                    ...
                    return (
                        <button
                            ...
                            className={`flex items-center gap-2 px-3 py-1.5 rounded-lg transition-all cursor-pointer hover:bg-slate-50 focus:outline-none ${isDimmed ? 'opacity-40' : 'opacity-100'
                ...
                <div className="flex bg-slate-100 p-1 rounded-lg">
                    {(['monthly', 'quarterly', 'yearly'] as ViewMode[]).map((mode) => (
                        <button
                            ...
                            className={`px-3 py-1 text-xs font-medium rounded-md transition-all focus:outline-none ${viewMode === mode
